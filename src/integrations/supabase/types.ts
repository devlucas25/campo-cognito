  ...
  public: {
    Tables: {
      ...
      assignments: {
        ...
        Relationships: [
          {
            foreignKeyName: "assignments_interviewer_id_fkey"
      ...
      messages: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "messages_survey_id_fkey"
            columns: ["survey_id"]
            isOneToOne: false
            referencedRelation: "surveys"
            referencedColumns: ["id"]
      ...
      responses: {
        ...
        Relationships: [
          {
            foreignKeyName: "responses_interviewer_id_fkey"
            columns: ["interviewer_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      calculate_margin_of_error: {
        Args: { sample_size: number; confidence_level?: number }
        Returns: number
      }
